    ...
    return (
        <div id="print-manifesto" className="hidden print:block w-full max-w-4xl mx-auto bg-white text-black font-serif p-8">
            ...
            <div className="space-y-10 text-lg leading-relaxed text-justify">
                ...
                {/* My Skills */}
                <section>
                    <h2 className="text-2xl font-bold uppercase tracking-widest mb-4 font-sans border-b border-neutral-300 pb-2 text-black">My Skills</h2>
                    <p className="mb-4 leading-loose">
                        <strong>Frontend:</strong> React, Next.js, Tailwind CSS, Framer Motion <br/>
                        <strong>Backend:</strong> Node.js, Express, NestJS, Laravel <br/>
                        <strong>Database:</strong> PostgreSQL, Prisma ORM <br/>
                        <strong>DevOps & Tools:</strong> Docker, Nginx, Git
                    </p>
                </section>
