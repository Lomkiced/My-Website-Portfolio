...
const skillCategories: SkillCategory[] = [
    {
        ...
        skills: [
            ...
            { name: "Redux", icon: SiRedux, color: "text-pink-500" },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: "PHP", icon: SiPhp, color: "text-rose-400" },
...
const colorMap: Record<string, string> = {
    ...
    "text-pink-500": "rgba(168, 85, 247, 0.4)",
    ...
    "text-rose-400": "rgba(129, 140, 248, 0.4)",
    "text-red-600": "rgba(220, 38, 38, 0.4)",
    "text-pink-500": "rgba(139, 92, 246, 0.4)",
...
export default function Skills() {
    return (
        <section id="skills" className="py-20 md:py-32 relative overflow-hidden">
            {/* Background accent */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-[600px] bg-gradient-to-b from-transparent via-rose-500/5 to-transparent blur-2xl md:blur-3xl -z-10 pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-pink-600/10 rounded-full blur-3xl md:blur-[100px] translate-y-1/2 -translate-x-1/2 pointer-events-none -z-10" />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    {skillCategories.map((category, catIndex) => (
                        ...
                        >
                            <div className="relative flex flex-col h-full p-6 sm:p-8 rounded-[2rem] bg-background/40 dark:bg-foreground/5 border border-neutral-200/60 dark:border-white/5 backdrop-blur-xl overflow-hidden group/bento hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
                                {/* Top-border gradient line that fades in on hover */}
                                <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-rose-500/50 dark:via-white/30 to-transparent opacity-0 group-hover/bento:opacity-100 transition-opacity duration-500 pointer-events-none" />
